...
public class ATSV15HistoryACLPolicyManager extends ATSHistoryACLPolicyManagerBase {
  ...
  protected void putDomain(ApplicationId applicationId, TimelineDomain timelineDomain)
    ...
    // the v1.5 overload is keyed by attempt; the domain is per application, so a dummy will do
    timelineClient.putDomain(ApplicationAttemptId.newInstance(applicationId, 1), timelineDomain);
  }
}
